-- Align companion template RPC with deployed schema names and avoid write/read mismatches.
-- Uses entry_id + compendium_entries.name + created_by and explicitly sets updated_at columns.
