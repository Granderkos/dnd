...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'spells.ability': 'Ability',
    'spells.spellDc': 'Spell DC',
    'spells.attack': 'Attack',
    'spells.cantrips': 'Cantrips',
    'spells.level': ({ level }) => `Level ${level}`,
    'spells.slots': 'Slots',
    'spells.noSpells': 'No spells',
    'spells.prepared': 'Prepared',
    'spells.dialog.details': 'Spell details',
    'spells.dialog.addCantrip': 'Add Cantrip',
    'spells.dialog.addLevelSpell': ({ level }) => `Add Level ${level} Spell`,
    'spells.dialog.enterDetails': 'Enter spell details',
    'spells.fields.name': 'Name',
    'spells.fields.namePlaceholder': 'Spell name',
    'spells.fields.ritual': 'Ritual',
    'spells.fields.concentration': 'Concentration',
    'spells.fields.reaction': 'Reaction',
    'spells.fields.castingTime': 'Casting Time',
    'spells.fields.castingTimePlaceholder': '1 action',
    'spells.fields.range': 'Range',
    'spells.fields.rangePlaceholder': '60 feet',
    'spells.fields.duration': 'Duration',
    'spells.fields.durationPlaceholder': '1 minute',
    'spells.fields.damage': 'Damage',
    'spells.fields.damagePlaceholder': '1d10 fire',
    'spells.fields.description': 'Description',
    'spells.fields.descriptionPlaceholder': 'Spell description...',
    'spells.actions.addSpell': 'Add Spell',
    'spells.actions.prepareTitle': 'Prepare Spell',
    'spells.actions.unprepareTitle': 'Unprepare Spell',
    'spells.actions.prepareDescription': ({ name }) => `Prepare "${name}"?`,
    'spells.actions.unprepareDescription': ({ name }) => `Unprepare "${name}"?`,
    'spells.actions.deleteTitle': 'Delete Spell',
    'spells.actions.deleteDescription': ({ name }) => `Delete "${name}"?`,
  ...
  cs: {
    ...
    'spells.ability': 'Atribut',
    'spells.spellDc': 'DC kouzla',
    'spells.attack': 'Útok',
    'spells.cantrips': 'Triky',
    'spells.level': ({ level }) => `Úroveň ${level}`,
    'spells.slots': 'Sloty',
    'spells.noSpells': 'Žádná kouzla',
    'spells.prepared': 'Připraveno',
    'spells.dialog.details': 'Detail kouzla',
    'spells.dialog.addCantrip': 'Přidat trik',
    'spells.dialog.addLevelSpell': ({ level }) => `Přidat kouzlo ${level}. úrovně`,
    'spells.dialog.enterDetails': 'Vyplň detaily kouzla',
    'spells.fields.name': 'Název',
    'spells.fields.namePlaceholder': 'Název kouzla',
    'spells.fields.ritual': 'Rituál',
    'spells.fields.concentration': 'Koncentrace',
    'spells.fields.reaction': 'Reakce',
    'spells.fields.castingTime': 'Doba seslání',
    'spells.fields.castingTimePlaceholder': '1 akce',
    'spells.fields.range': 'Dosah',
    'spells.fields.rangePlaceholder': '60 stop',
    'spells.fields.duration': 'Trvání',
    'spells.fields.durationPlaceholder': '1 minuta',
    'spells.fields.damage': 'Zranění',
    'spells.fields.damagePlaceholder': '1k10 oheň',
    'spells.fields.description': 'Popis',
    'spells.fields.descriptionPlaceholder': 'Popis kouzla...',
    'spells.actions.addSpell': 'Přidat kouzlo',
    'spells.actions.prepareTitle': 'Připravit kouzlo',
    'spells.actions.unprepareTitle': 'Odebrat připravenost',
    'spells.actions.prepareDescription': ({ name }) => `Připravit "${name}"?`,
    'spells.actions.unprepareDescription': ({ name }) => `Odebrat připravenost kouzla "${name}"?`,
    'spells.actions.deleteTitle': 'Smazat kouzlo',
    'spells.actions.deleteDescription': ({ name }) => `Smazat "${name}"?`,
