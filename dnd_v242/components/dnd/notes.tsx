  ...
  return (
    <ScrollArea className="h-[calc(100vh-4rem)]">
      <div className="px-3 py-4 pb-24">
        <PageShell width="max-w-3xl">
          <div className="-mx-1 overflow-x-auto px-1 pb-1 scrollbar-hidden"><div className="flex w-max gap-2 pr-4">
              <Button
                size="sm"
              ...
              <div className="-mx-1 overflow-x-auto px-1 pb-1 scrollbar-hidden"><div className="flex w-max gap-2 pr-4">
                {NOTE_CATEGORIES.map(({ id, icon: Icon, labelKey }) => (
                  <Button
                    ...
                    variant="outline"
                    onClick={() => addNote(id)}
                    className="h-11 min-w-11 gap-1.5 rounded-2xl px-4 shrink-0"
                    title={t(labelKey)}
                  >
