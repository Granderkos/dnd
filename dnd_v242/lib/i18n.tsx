...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'spellbook.level': ({ value }) => `Level ${value}`,
    'spellbook.noSpells': 'No spells',
    'spellbook.slots': 'Slots',
    'spellbook.prepared': 'Prepared',
    'spellbook.unprepareSpell': 'Unprepare Spell',
    'spellbook.prepareSpell': 'Prepare Spell',
    'spellbook.deleteSpell': 'Delete Spell',
    'spellbook.confirmPrepare': ({ action, name }) => `${action} "${name}"?`,
    'spellbook.confirmDelete': ({ name }) => `Delete "${name}"?`,
  ...
  cs: {
    ...
    'character.proficiencyBonus': 'Bonus odbornosti',
    ...
    'character.combat.max': 'Max',
    'character.combat.temp': 'Temp',
    'character.combat.hitDice': 'Životové kostky',
    'character.combat.actions': 'Útoky a sesílání kouzel',
    ...
    'spellbook.level': ({ value }) => `Úroveň ${value}`,
    'spellbook.noSpells': 'Žádná kouzla',
    'spellbook.slots': 'Sloty',
    'spellbook.prepared': 'Připravené',
    'spellbook.unprepareSpell': 'Odebrat připravenost',
    'spellbook.prepareSpell': 'Připravit kouzlo',
    'spellbook.deleteSpell': 'Smazat kouzlo',
    'spellbook.confirmPrepare': ({ action, name }) => `${action} "${name}"?`,
    'spellbook.confirmDelete': ({ name }) => `Smazat "${name}"?`,
    'spellbook.spellDetails': 'Detail kouzla',
    'spellbook.ritual': 'Rituál',
    'spellbook.concentration': 'Soustředění',
    ...
    'spellbook.addLevelSpell': ({ value }) => `Přidat kouzlo ${value}. úrovně`,
    ...
    'spellbook.spellDescription': 'Popis kouzla...',
    'spellbook.addSpell': 'Přidat kouzlo',
