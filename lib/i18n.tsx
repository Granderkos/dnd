...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'character.templateSources': 'Template Sources',
    'character.classTemplate': 'Class template',
    'character.raceTemplate': 'Race template',
    ...
    'inventory.createCustomItem': 'Create Custom Item',
    'inventory.importFromTemplate': 'Import from Template',
    'inventory.importToolsTemplates': 'Import tools templates',
    ...
    'fight.hp': 'HP',
    'fight.ac': 'AC',
    'fight.deathSaves': 'Death saves',
    'fight.deathSuccess': 'Success',
    'fight.deathFailure': 'Failure',
    'compendium.creaturesTitle': 'Creatures',
    'compendium.companionsTitle': 'Companions',
    'compendium.searchPlaceholder': 'Search unlocked creatures...',
    ...
    'compendium.unknownName': '???',
    'compendium.lockedHint': 'Unknown creature. Encounter it in combat to reveal details.',
    ...
    'compendium.addCustom': 'Add custom',
    'compendium.importTemplate': 'Import template',
    'compendium.createCompanionTitle': 'Create companion',
    'compendium.createCompanionAction': 'Create companion',
    'compendium.importCompanionTitle': 'Import companion template',
    'compendium.importCompanionAction': 'Import companion',
    'compendium.searchTemplates': 'Search templates...',
    'compendium.noCompanionTemplates': 'No companion templates found.',
    'compendium.loadTemplatesFailed': 'Failed to load templates.',
    'compendium.customName': 'Companion name',
    'compendium.customNotes': 'Notes / traits / actions',
    'compendium.stat.ac': 'Armor Class',
    'compendium.stat.hp': 'Hit Points',
    'compendium.stat.speed': 'Speed',
    'compendium.stat.skills': 'Skills',
    'compendium.stat.senses': 'Senses',
    'compendium.stat.traits': 'Traits',
    'compendium.stat.actions': 'Actions',
  ...
  cs: {
    ...
    'character.templateSources': 'Šablonové zdroje',
    'character.classTemplate': 'Šablona povolání',
    'character.raceTemplate': 'Šablona rasy',
    ...
    'inventory.tools': 'Nástroje',
    'inventory.consumables': 'Spotřební věci',
    'inventory.supplies': 'Zásoby',
    'inventory.treasure': 'Poklady',
    'inventory.other': 'Ostatní',
    'inventory.createCustomItem': 'Vytvořit vlastní předmět',
    'inventory.importFromTemplate': 'Importovat ze šablony',
    'inventory.importToolsTemplates': 'Importovat šablony nástrojů',
    ...
    'inventory.editAction': 'Upravit',
    'inventory.itemDetails': 'Detail předmětu',
    'inventory.value': 'Hodnota',
    'inventory.weight': 'Váha',
    ...
    'fight.hp': 'HP',
    'fight.ac': 'AC',
    'fight.deathSaves': 'Záchranné hody',
    'fight.deathSuccess': 'Úspěch',
    'fight.deathFailure': 'Neúspěch',
    'compendium.creaturesTitle': 'Bestie',
    'compendium.companionsTitle': 'Společníci',
    'compendium.searchPlaceholder': 'Hledej mezi odemčenými bestiemi...',
    ...
    'compendium.unknownName': '???',
    'compendium.lockedHint': 'Neznámá bytost. Odemkneš ji po setkání v souboji.',
    ...
    'compendium.addCustom': 'Přidat custom',
    'compendium.importTemplate': 'Importovat šablonu',
    'compendium.createCompanionTitle': 'Vytvořit společníka',
    'compendium.createCompanionAction': 'Vytvořit společníka',
    'compendium.importCompanionTitle': 'Importovat šablonu společníka',
    'compendium.importCompanionAction': 'Importovat společníka',
    'compendium.searchTemplates': 'Hledat šablony...',
    'compendium.noCompanionTemplates': 'Žádné šablony společníků nenalezeny.',
    'compendium.loadTemplatesFailed': 'Nepodařilo se načíst šablony.',
    'compendium.customName': 'Jméno společníka',
    'compendium.customNotes': 'Poznámky / vlastnosti / akce',
    'compendium.stat.ac': 'Třída zbroje',
    'compendium.stat.hp': 'Životy',
    'compendium.stat.speed': 'Rychlost',
    'compendium.stat.skills': 'Dovednosti',
    'compendium.stat.senses': 'Smysly',
    'compendium.stat.traits': 'Vlastnosti',
    'compendium.stat.actions': 'Akce',
