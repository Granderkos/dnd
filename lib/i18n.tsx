...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'spellbook.createCustom': 'Create Custom',
    'spellbook.importTemplate': 'Import Template',
    'spellbook.searchTemplates': 'Search templates',
    'spellbook.duplicateTitle': 'Spell already exists',
    'spellbook.duplicateDescription': ({ name }) => `"${name}" is already in your spellbook. Add another copy?`,
  ...
  cs: {
    ...
    'spellbook.createCustom': 'Vytvořit vlastní',
    'spellbook.importTemplate': 'Importovat šablonu',
    'spellbook.searchTemplates': 'Hledat šablony',
    'spellbook.duplicateTitle': 'Kouzlo už existuje',
    'spellbook.duplicateDescription': ({ name }) => `"${name}" už v knize máš. Přidat další kopii?`,
